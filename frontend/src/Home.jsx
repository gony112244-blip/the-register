...
function Home() {
  ...
  const faqData = {
    ...
    cost: [
      ...
      {
        q: 'למה לשלם דמי שידוך אם האתר עצמו חינם?',
        a: 'האתר מספק את הכלים — אבל השדכנית היא מי שמוודאת שמה שמאחורי הכלים ראוי וכן. ברגע שהשידוך מתקדם, השדכנית מלווה את שני הצדדים, מתאמת ומסייעת להוביל את התהליך. דמי השידוך מגיעים רק על תוצאה — שידוך שנגמר בהצלחה בסייעתא דשמיא.'
      },
    ],
    phone: [
      {
      ...
      {
        q: 'אילו מקשים צריך לדעת? (מדריך מהיר)',
        a: 'מפת המקשים — שמור אותה: 1 = כן / מעוניין / אישור. 2 = לא / דחייה. 4 = פרטים נוספים על הצעה. 5 = תיאור מלא של הצעה. 8 = הבא / דלג. 9 = הגדרות (שינוי קוד). 0 = חזרה לתפריט הראשי. # = חזרה לתפריט הראשי מכל מקום. אלה אותם מקשים בכל המסכים — לא צריך ללמוד שוב ושוב.'
      },
      {
        q: 'איך להאזין להצעה ולהגיב עליה?',
        a: 'אחרי הכניסה, בחר 1 — "הצעות חדשות". המערכת תקריא: שם, גיל, עיר, מוסד. אם רוצה לשמוע עוד — הקש 4 (מוצא, עיסוק, גובה) ואחר כך 5 (תיאור מלא מהשדכנית). כשאתה מוכן: הקש 1 אם מעוניין, 2 אם לא, 8 כדי לדלג להצעה הבאה. אם שלחת עניין ושני הצדדים הביעו ענין — תקבל עדכון בפעם הבאה שתחייג.'
      },
      {
        q: 'איך להפוך את השימוש לנוח יותר — טיפים לחסוך זמן',
        a: 'כמה טיפים שיעשו את החיים קלים: (1) הגדר כניסה מהירה — ללא PIN. בהגדרות מערכת הטלפון באתר, בחר "כניסה מהירה" — כך תיכנס ישר לתפריט בלי להקיש קוד. (2) השתמש במקש 0 ולא # — מהיר יותר לחזרה לתפריט. (3) אחרי שמעת מספיק — הקש 1 או 2 מיד, לא צריך להמתין לסוף ההקראה. (4) הצעות שדלגת עליהן — ניתן לחפש בהן דרך "כל ההצעות" (מקש 6 בתפריט). (5) הטלפון זוכר את מקום העצירה — אם ניתקת באמצע, החיוג הבא יחדש מהמקום הנכון.'
      },
      {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: '#4a4540', lineHeight: '2', fontSize: '1.05rem', margin: 0 }}>
                ...
                דמי שידוך לשדכנית שליוותה את התהליך.
                <br /><br />
                <span style={{ fontSize: '0.95rem', color: '#7a756d' }}>
                  יש שאלות בנושא דמי השידוך? מוזמנים לפנות אלינו בכל עת.
                </span>
              </p>
            </div>
          </div>
