  ...
  const faqData = {
    ...
    cost: [
      ...
      },
      {
        ...
        a: 'רק אם שידוך יוצא לפועל בסייעתא דשמיא — יש לשלם דמי שידוך של 3,500 ש"ח לשדכנית. דמי השידוך הם עבור עבודת השדכנית בלבד, ולא עבור השימוש באתר. יש שאלות בנושא? מוזמנים לפנות אלינו בכל עת.'
      },
      {
