  ...
  const faqData = {
    ...
    cost: [
      ...
      },
      {
        ...
        a: 'ההרשמה והשימוש באתר אינם כרוכים בתשלום. במקרה ששידוך יוצא לפועל בסייעתא דשמיא דרך המערכת, דמי השדכנות ייקבעו בתיאום מראש עם השדכנית ובגישה הוגנת ומכובדת. יש שאלות? מוזמנים לפנות אלינו בכל עת — בשמחה.'
      },
            ...
            <div style={{
              ...
              <p style={{ color: '#4a4540', lineHeight: '2', fontSize: '1.05rem', margin: 0 }}>
                ...
                <span style={{ fontSize: '0.95rem', color: '#7a756d' }}>
                  יש שאלות? מוזמנים לפנות אלינו בכל עת — בשמחה.
                </span>
              </p>
            </div>
