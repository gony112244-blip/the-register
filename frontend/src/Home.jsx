...
function Home() {
  ...
  const faqData = {
    general: [
      {
        q: 'למי מיועד הפנקס?',
        a: 'הפנקס מיועד לשידוכים לחרדים (בני תורה ובנות סמינר) וכן לשידוכים והכרויות לדתיים המחפשים זיווג בדרך מכובדת וצנועה. המערכת בנויה מתוך הבנה עמוקה של הצרכים, הרגישויות והמנהגים של כלל הציבור החרדי והדתי-לאומי — ומטרתנו שכל שלב בתהליך ייעשה בדרך ארץ ובכבוד.'
      },
      {
        q: 'האם הפנקס הוא אתר שידוכים לחרדים או הכרויות לדתיים?',
        a: 'הפנקס משמש פלטפורמה רחבה המציעה שידוכים לחרדים לצד שידוכים והכרויות לדתיים. המערכת עושה התאמות מדויקות לפי הגדרות המגזר והקהילה הספציפיים שלך, תוך שמירה מלאה על פרטיות, דיסקרטיות וצניעות בכל שלב.'
      },
      {
    ...
    howItWorks: [
      {
        q: 'איך מתחילים?',
        a: 'נכנסים לאתר, ממלאים טופס רישום קצר עם פרטים בסיסיים, מעלים ת"ז או אמצעי זיהוי רשמי אחר (לאימות בלבד, נמחק אוטומטית לאחר האישור), וממתינים לאישור. לאחר שהמנהלת מאשרת את הפרופיל — מתחילים לקבל הצעות.'
      },
      {
    ...
    privacy: [
      ...
      {
        q: 'האם אמצעי הזיהוי שמועלה נשמר במערכת?',
        a: 'לא. ת"ז או אמצעי הזיהוי האחר משמש לאימות חד פעמי בלבד — לא מוצג לאף משתמש אחר, ונמחק אוטומטית מהמערכת ברגע שהמנהלת מאשרת את הפרופיל. אם יש קושי להעלות אמצעי זיהוי, ניתן לפנות אלינו ונשתדל לסייע באופן אישי.'
      },
      {
    ...
    cost: [
      {
        ...
        a: 'השימוש באתר חינם לחלוטין — הרישום, הגדרת ההעדפות, קבלת הצעות, בירורים ושלב ההתאמה — הכל ללא עלות. דמי שידוך משולמים לשדכנית רק אם השידוך יצא לפועל בהצלחה בסייעתא דשמיא.'
      },
      {
        q: 'מתי משלמים דמי שידוך וכמה?',
        a: 'רק אם שידוך יוצא לפועל בסייעתא דשמיא — יש לשלם דמי שידוך של 3,500 ש"ח לשדכנית. דמי השידוך הם עבור עבודת השדכנית בלבד, ולא עבור השימוש באתר. יש שאלות? מוזמנים לפנות לשדכנית מראש, בשמחה ובפתיחות.'
      },
      {
    ...
    phone: [
      {
        ...
        a: 'כמעט הכל — ללא אינטרנט בכלל: להאזין להצעות חדשות ולהגיב עליהן, לאשר או לדחות פניות שידוך, לטפל בבקשות תמונה, לעקוב אחרי שידוכים פעילים ולשמוע הודעות מהשדכנית. הכל בשיחה קצרה, גם מטלפון כשר.'
      },
      {
        q: 'איך נכנסים למערכת בטלפון?',
        a: 'פשוט: חייג למספר 02-313-0778. המערכת מזהה אותך אוטומטית לפי מספר הטלפון — ואתה נכנס ישירות לתפריט. אם הגדרת קוד כניסה (PIN) — תתבקש להזין 4 ספרות בלבד. הכניסה לוקחת שניות.'
      },
      {
    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <h2 className="site-subtitle">שידוכים לחרדים, הכרויות לדתיים ובני תורה</h2>
          <p className="tagline">
            לא לוח מודעות. <span className="tagline-highlight">פנקס אישי.</span>
            <br />
            פלטפורמה מובילה לשידוכים לחרדים ושידוכים והכרויות לדתיים.
            <br />
        ...
        <div className="steps-container">
          ...
          <div className="step-item">
            ...
            <div className="step-content">
              ...
              <p>ממלאים פרטים בסיסיים, מעלים ת"ז או אמצעי זיהוי רשמי אחר (לאימות בלבד, נמחק אוטומטית לאחר האישור), וממתינים לאישור. אנחנו מוודאים שכולם כאן רציניים.</p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: '#4a4540', lineHeight: '2', fontSize: '1.05rem', margin: 0 }}>
                אם שידוך יוצא לפועל בסייעתא דשמיא, דמי השידוך הם <strong>3,500 ש"ח</strong> לשדכנית שליוותה את התהליך.
                <br /><br />
