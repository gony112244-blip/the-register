...
function Home() {
  ...
  const faqData = {
    ...
    howItWorks: [
      {
        q: 'איך מתחילים?',
        a: 'נכנסים לאתר, ממלאים טופס רישום קצר עם פרטים בסיסיים, מעלים אמצעי זיהוי רשמי (תעודת זהות, רישיון נהיגה או דרכון — לאימות בלבד, ונמחק אוטומטית לאחר האישור), וממתינים לאישור. לאחר שהמנהלת מאשרת את הפרופיל — מתחילים לקבל הצעות.'
      },
      {
    ...
    privacy: [
      ...
      },
      {
        ...
        a: 'לא. אמצעי הזיהוי (תעודת זהות, רישיון נהיגה או דרכון) משמש לאימות חד פעמי בלבד — לא מוצג לאף משתמש אחר, ונמחק אוטומטית מהמערכת ברגע שהמנהלת מאשרת את הפרופיל. אם יש קושי להעלות אחד מהמסמכים הללו, ניתן לפנות אלינו ונשתדל לסייע באופן אישי.'
      },
      {
