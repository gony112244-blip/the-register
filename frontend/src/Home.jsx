  ...
  const faqData = {
    ...
    cost: [
      ...
      },
      {
        ...
        a: 'רק אם שידוך יוצא לפועל בסייעתא דשמיא — יש לשלם דמי שידוך של 4,000 ש"ח לשדכנית שליוותה את התהליך. דמי השידוך הם עבור העבודה של השדכנית ולא עבור השימוש באתר. יש שאלות בנושא? מוזמנים לפנות אלינו בכל עת.'
      },
      {
        q: 'למה לשלם דמי שידוך אם האתר עצמו חינם?',
        a: 'האתר מספק כלי חיפוש ובירורים. אך ברגע שהשידוך מתקדם לשלב רציני, שדכנית מקצועית נכנסת לתמונה, מלווה את שני הצדדים, מתאמת ועוזרת להוביל את התהליך. דמי השידוך מגיעים רק על תוצאה — שידוך שנגמר בהצלחה.'
      },
    ],
    phone: [
      {
