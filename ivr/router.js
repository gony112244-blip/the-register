        ...
        if (key === '6') {
            ...
            const actionsText6 = isRefReq6
                ? g(user.gender,
                    ...
                    'הָקִישִׁי אחת להסכמה ומעבר לאתר להשלמת הפרטים. הָקִישִׁי שתיים לציון שאינך יכולה לספק ממליץ. הָקִישִׁי תשע לשמיעה חוזרת. הָקִישִׁי שמונה להודעה הבאה. הָקִישִׁי אפס לתפריט.'
                )
                : g(user.gender,
    ...
    if (session.state === 'photos') {
        ...
        const buildPhotoText = (ph) => {
            ...
            const acts = g(user.gender,
                'הָקֵשׁ אחת — הסכם לחשיפה. הָקֵשׁ שתיים — דחה. הָקֵשׁ ארבע לפרטים על המבקש. הָקֵשׁ שמונה — דלג. הָקֵשׁ תשע לשמיעה חוזרת. הָקֵשׁ אפס לתפריט.',
                'הָקִישִׁי אחת — הסכמי לחשיפה. הָקִישִׁי שתיים — דחי. הָקִישִׁי ארבע לפרטים על המבקשת. הָקִישִׁי שמונה — דלגי. הָקִישִׁי תשע לשמיעה חוזרת. הָקִישִׁי אפס לתפריט.'
            );
        ...
        if (key && requesterId) {
            ...
            if (key === '4') {
                ...
                const actDetail = g(user.gender,
                    'הָקֵשׁ אחת — הסכם לחשיפה. הָקֵשׁ שתיים — דחה. הָקֵשׁ שמונה — דלג. הָקֵשׁ תשע לשמיעה חוזרת. הָקֵשׁ אפס לתפריט.',
                    'הָקִישִׁי אחת — הסכמי לחשיפה. הָקִישִׁי שתיים — דחי. הָקִישִׁי שמונה — דלגי. הָקִישִׁי תשע לשמיעה חוזרת. הָקִישִׁי אפס לתפריט.'
                );
            ...
            // מקש לא מוכר
            const actionsText = g(user.gender,
                'מקש לא מוכר. הָקֵשׁ אחת — הסכמה. הָקֵשׁ שתיים — דחייה. הָקֵשׁ ארבע לפרטים. הָקֵשׁ שמונה — דלג. הָקֵשׁ תשע לשמיעה חוזרת. הָקֵשׁ אפס לתפריט.',
                'מקש לא מוכר. הָקִישִׁי אחת — הסכמה. הָקִישִׁי שתיים — דחייה. הָקִישִׁי ארבע לפרטים. הָקִישִׁי שמונה — דלגי. הָקִישִׁי תשע לשמיעה חוזרת. הָקִישִׁי אפס לתפריט.'
            );
            const file = await textToYemot(actionsText);
            return yemotRead(res, file, 'digits', 1, 1, 8);
        }
